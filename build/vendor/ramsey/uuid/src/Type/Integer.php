 ...
 * @psalm-immutable
 */
final class Integer implements \RayGlobalScoped\Ramsey\Uuid\Type\NumberInterface
{
    /**
     * @var string
     */
    ...
    public function __construct($value)
    {
        ...
        if (!\ctype_digit($value)) {
            throw new \RayGlobalScoped\Ramsey\Uuid\Exception\InvalidArgumentException('Value must be a signed integer or a string containing only ' . 'digits 0-9 and, optionally, a sign (+ or -)');
        }
