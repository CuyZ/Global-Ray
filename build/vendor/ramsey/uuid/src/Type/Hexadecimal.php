 ...
 * @psalm-immutable
 */
final class Hexadecimal implements \RayGlobalScoped\Ramsey\Uuid\Type\TypeInterface
{
    /**
     * @var string
     */
    ...
    public function __construct(string $value)
    {
        ...
        if (!\ctype_xdigit($value)) {
            throw new \RayGlobalScoped\Ramsey\Uuid\Exception\InvalidArgumentException('Value must be a hexadecimal number');
        }
        $this->value = $value;
    }
