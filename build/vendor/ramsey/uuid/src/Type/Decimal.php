 ...
 * @psalm-immutable
 */
final class Decimal implements \RayGlobalScoped\Ramsey\Uuid\Type\NumberInterface
{
    /**
     * @var string
     */
    ...
    public function __construct($value)
    {
        $value = (string) $value;
        if (!\is_numeric($value)) {
            throw new \RayGlobalScoped\Ramsey\Uuid\Exception\InvalidArgumentException('Value must be a signed decimal or a string containing only ' . 'digits 0-9 and, optionally, a decimal point or sign (+ or -)');
        }
