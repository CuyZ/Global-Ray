...
namespace RayGlobalScoped\Ramsey\Uuid\Type;
 ...
 * @psalm-immutable
 */
final class Time implements \RayGlobalScoped\Ramsey\Uuid\Type\TypeInterface
{
    /**
     * @var IntegerObject
     */
    ...
    {
        $this->seconds = new \RayGlobalScoped\Ramsey\Uuid\Type\Integer($seconds);
        $this->microseconds = new \RayGlobalScoped\Ramsey\Uuid\Type\Integer($microseconds);
    }
    public function getSeconds() : \RayGlobalScoped\Ramsey\Uuid\Type\Integer
    {
        return $this->seconds;
    }
    public function getMicroseconds() : \RayGlobalScoped\Ramsey\Uuid\Type\Integer
    {
    ...
    public function unserialize($serialized) : void
    {
        ...
        if (!isset($time->seconds) || !isset($time->microseconds)) {
            throw new \RayGlobalScoped\Ramsey\Uuid\Exception\UnsupportedOperationException('Attempted to unserialize an invalid value');
        }
