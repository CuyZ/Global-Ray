...
namespace RayGlobalScoped\Ramsey\Uuid\Provider\Dce;
 ...
 */
class SystemDceSecurityProvider implements \RayGlobalScoped\Ramsey\Uuid\Provider\DceSecurityProviderInterface
{
    /**
    ...
    {
        static $uid = null;
        if ($uid instanceof \RayGlobalScoped\Ramsey\Uuid\Type\Integer) {
            return $uid;
        }
        if ($uid === null) {
        ...
        if ($uid === '') {
            throw new \RayGlobalScoped\Ramsey\Uuid\Exception\DceSecurityException('Unable to get a user identifier using the system DCE ' . 'Security provider; please provide a custom identifier or ' . 'use a different provider');
        }
        $uid = new \RayGlobalScoped\Ramsey\Uuid\Type\Integer($uid);
        return $uid;
    }
    /**
    ...
    {
        static $gid = null;
        if ($gid instanceof \RayGlobalScoped\Ramsey\Uuid\Type\Integer) {
            return $gid;
        }
        if ($gid === null) {
        ...
        if ($gid === '') {
            throw new \RayGlobalScoped\Ramsey\Uuid\Exception\DceSecurityException('Unable to get a group identifier using the system DCE ' . 'Security provider; please provide a custom identifier or ' . 'use a different provider');
        }
        $gid = new \RayGlobalScoped\Ramsey\Uuid\Type\Integer($gid);
        return $gid;
    }
    /**
