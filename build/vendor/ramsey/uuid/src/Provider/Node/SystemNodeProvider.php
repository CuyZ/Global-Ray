 ...
 */
class SystemNodeProvider implements \RayGlobalScoped\Ramsey\Uuid\Provider\NodeProviderInterface
{
    /**
    ...
    public function getNode() : \RayGlobalScoped\Ramsey\Uuid\Type\Hexadecimal
    {
        ...
        if ($node === '') {
            throw new \RayGlobalScoped\Ramsey\Uuid\Exception\NodeException('Unable to fetch a node for this system');
        }
        return new \RayGlobalScoped\Ramsey\Uuid\Type\Hexadecimal($node);
    }
    /**
