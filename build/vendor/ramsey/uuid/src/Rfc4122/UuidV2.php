 ...
 * @psalm-immutable
 */
final class UuidV2 extends \RayGlobalScoped\Ramsey\Uuid\Uuid implements \RayGlobalScoped\Ramsey\Uuid\Rfc4122\UuidInterface
{
    /**
    ...
    {
        if ($fields->getVersion() !== \RayGlobalScoped\Ramsey\Uuid\Uuid::UUID_TYPE_DCE_SECURITY) {
            throw new \RayGlobalScoped\Ramsey\Uuid\Exception\InvalidArgumentException('Fields used to create a UuidV2 must represent a ' . 'version 2 (DCE Security) UUID');
        }
    ...
    {
        return \RayGlobalScoped\Ramsey\Uuid\Uuid::DCE_DOMAIN_NAMES[$this->getLocalDomain()];
    }
    /**
     * Returns the local identifier for the domain used to create this version 2 UUID
     */
    public function getLocalIdentifier() : \RayGlobalScoped\Ramsey\Uuid\Type\Integer
    {
        /** @var Rfc4122FieldsInterface $fields */
        $fields = $this->getFields();
        return new \RayGlobalScoped\Ramsey\Uuid\Type\Integer($this->numberConverter->fromHex($fields->getTimeLow()->toString()));
    }
}
