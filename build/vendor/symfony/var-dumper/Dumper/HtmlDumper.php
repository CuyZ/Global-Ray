 ...
 */
class HtmlDumper extends \RayGlobalScoped\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \RayGlobalScoped\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     * {@inheritdoc}
     */
    public function dump(\RayGlobalScoped\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, array $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\RayGlobalScoped\Symfony\Component\VarDumper\Cloner\Cursor $cursor, int $type, $class, bool $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \RayGlobalScoped\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\RayGlobalScoped\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine(int $depth, bool $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \RayGlobalScoped\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \RayGlobalScoped\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
