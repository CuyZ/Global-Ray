...
use RayGlobalScoped\Symfony\Component\Console\Formatter\OutputFormatterStyle;
use RayGlobalScoped\Symfony\Component\Console\Input\ArrayInput;
 ...
 * @final
 */
class CliDescriptor implements \RayGlobalScoped\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\RayGlobalScoped\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\RayGlobalScoped\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \RayGlobalScoped\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \RayGlobalScoped\Symfony\Component\Console\Style\SymfonyStyle(new \RayGlobalScoped\Symfony\Component\Console\Input\ArrayInput([]), $output);
