 ...
 */
namespace RayGlobalScoped\Symfony\Component\Stopwatch;

use RayGlobalScoped\Symfony\Contracts\Service\ResetInterface;
// Help opcache.preload discover always-needed symbols
\class_exists(\RayGlobalScoped\Symfony\Component\Stopwatch\Section::class);
/**
 * Stopwatch provides a way to profile code.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class Stopwatch implements \RayGlobalScoped\Symfony\Contracts\Service\ResetInterface
{
    /**
     * @var bool
     */
    ...
    {
        $this->sections = $this->activeSections = ['__root__' => new \RayGlobalScoped\Symfony\Component\Stopwatch\Section(null, $this->morePrecision)];
    }
}
