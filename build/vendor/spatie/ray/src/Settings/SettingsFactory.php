...
namespace RayGlobalScoped\Spatie\Ray\Settings;

class SettingsFactory
{
    public static $cache = [];
    public static function createFromConfigFile(string $configDirectory = null) : \RayGlobalScoped\Spatie\Ray\Settings\Settings
    {
        $settingValues = (new static())->getSettingsFromConfigFile($configDirectory);
        $settings = new \RayGlobalScoped\Spatie\Ray\Settings\Settings($settingValues);
