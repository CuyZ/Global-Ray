...
use RayGlobalScoped\Symfony\Component\Stopwatch\StopwatchEvent;
class MeasurePayload extends \RayGlobalScoped\Spatie\Ray\Payloads\Payload
{
    /** @var string */
    protected $name;
    /** @var bool */
    ...
    public function __construct(string $name, \RayGlobalScoped\Symfony\Component\Stopwatch\StopwatchEvent $stopwatchEvent)
    {
        $this->name = $name;
